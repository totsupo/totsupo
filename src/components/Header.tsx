      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          ...
          <nav className="hidden md:flex space-x-8">
            ...
            <Link to="/article" className="text-gray-900 hover:text-blue-600 px-3 py-2 font-medium">
              記事
            </Link>
            <Link to="/contact" className="text-gray-900 hover:text-blue-600 px-3 py-2 font-medium">
              お問い合わせ
            </Link>
          </nav>
