import { Newspaper, MapPin, Calendar, Phone, Train, Utensils, Star } from 'lucide-react';
  ...
  return (
    <div>
      ...
      <div className="relative">
        <div className="w-full h-[60vh] bg-cover bg-center" style={{ backgroundImage: 'url(https://images.unsplash.com/photo-1551641506-ee5bf4cb45f1?ixlib=rb-1.2.1&auto=format&fit=crop&w=2000&q=80)' }}>
          <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center">
            <div className="text-center text-white px-4">
              <h1 className="text-4xl md:text-6xl font-bold mb-4">戸塚つーしん</h1>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {restaurants.map(restaurant => (
              <div key={restaurant.id} className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition duration-300">
                <img
      ...
      <section className="py-12 px-4 max-w-7xl mx-auto">
        <div className="bg-white p-8 rounded-lg shadow-md">
          <h2 className="text-3xl font-bold mb-4 text-center">戸塚つーしんについて</h2>
          <p className="text-lg text-gray-700 mb-6 text-center">
            「戸塚つーしん」は、横浜市戸塚区の魅力を発信するローカルメディアです。<br />
