...
describe("ContactPage", () => {
  ...
  it("renders page title and description", () => {
    ...
    expect(
      screen.getByText(/戸塚ぽーたるへのご連絡は、メールまたは X の メッセージ/),
    ).toBeInTheDocument()
  })
  ...
  it("renders send email button with correct mailto link", () => {
    ...
    expect(sendButton).toHaveAttribute(
      "href",
      expect.stringContaining("mailto:totsuka.portal@gmail.com"),
    )
    expect(sendButton).toHaveAttribute(
      "href",
      expect.stringContaining(encodeURIComponent("【戸塚ぽーたる】お問い合わせ")),
    )
  })
